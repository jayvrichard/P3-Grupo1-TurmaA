 ...
 * @author Matheus
 */
public class PersProdRem extends javax.swing.JFrame {

    /**
     * Creates new form PersProdRem
     */
    public PersProdRem() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PersProdRem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PersProdRem().setVisible(true);
            }
        });
    }
