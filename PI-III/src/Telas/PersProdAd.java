 ...
 * @author Matheus
 */
public class PersProdAd extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Deseja inserir adicionais ?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PersProdAd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PersProdAd().setVisible(true);
            }
        });
    }
